...
- [x] 笔记中引用本地图片后，可在对话中对图片提问
- [x] 图片处理失败不中断文本流程
- [x] 超限/缺失/格式不支持时有 Notice 提示
- [x] 不含图片的对话行为不变
- [x] Settings 可控
- [x] 单元测试覆盖 `extractLocalImageRefs()`
...
- [x] 在 Raw/ 中创建新笔记后，自动生成 tags 和 summary
- [x] 已标注笔记不会重复标注
- [x] 标签优先复用已有标签体系
- [x] Settings 开关有效
- [x] 不影响非目标文件夹
...
- [x] 「整理知识库」命令可自动整理 Raw/ 笔记
- [x] 整理结果结构合理，有 tags + wiki-link
- [x] 蒸馏按钮可提取对话知识为 Wiki 条目
- [x] 每步操作有进度提示
- [x] 不会处理已整理/已标注的笔记
