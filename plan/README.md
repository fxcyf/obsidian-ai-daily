...
- ✅ [桌面代理模式](feature-proxy-mode.md) — 移动端通过桌面 proxy-server 使用 Claude Code 订阅额度
...
- [知识库能力深化](feature-knowledge-enhancement.md) — 归入 [语义搜索](feature-semantic-search.md) 和 [Agentic Vault](feature-agentic-vault.md)
- [工作流自动化](feature-automation.md) — 归入 [LLM 自组织](feature-llm-driven-org.md)
